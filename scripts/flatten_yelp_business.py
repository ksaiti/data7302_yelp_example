...
#each business record in the JSON file will be turned into one flat dictionary, then we will store each of those dictionaries in the "rows" list
...
with open(INPUT_FILE, "r", encoding="utf-8") as f:   # opens the JSON file, "r" read mode, encoding to ensure that it reads the text correclty, f gives the file name
    for line in f:
        ...
        row = {                                        # creating the new flat dictionary
            ...
            "categories": item.get("categoties"),
